  ...
  data() {
    return {
      ...
      notice: [
        ...
        {
          content:
            "杭州热电:关于对杭州热电集团股份有限公司股票交易严重异常波动问询函的回复",
          timestamp: "2023-05-31",
          type: "",
        },
        {
          content:
            "杭州热电:杭州热电集团股份有限公司 2022年年度权益分派实施公告杭州热电:股票交易风险提示公告",
          timestamp: "2023-05-31",
          type: "",
        },
        {
...
.select-area {
  .mask-area {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(0, 0, 0, 0.5); /* 设置遮罩层的背景色及透明度 */
    z-index: 1; /* 确保遮罩层在选择器之下 */
  }
  .notice-selector {
    position: fixed;
    width: 100%;
    height: 40%;
    bottom: 0; /* 调整选择器距离底部的距离 */
    background-color: white;
    border-radius: 6px 6px 0 0; /* 设置选择器的圆角 */
    z-index: 2; /* 确保选择器位于遮罩层上方 */
